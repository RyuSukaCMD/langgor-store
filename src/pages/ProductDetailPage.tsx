    ...
    <main className="container detail-main">
      ...
      <section className="detail-grid">
        ...
        <div className="detail-info">
          ...
          <div className="detail-assurance"><span><ShieldCheck/><b>Terverifikasi</b><small>Diperiksa sebelum dikirim</small></span><span><LockKeyhole/><b>Cookie privat</b><small>Token mentah tidak ditampilkan</small></span><span><Clock3/><b>Aktivasi cepat</b><small>Rata-rata 12 detik</small></span></div>
        </div>
      </section>
